...
namespace UKHO.ERPFacade.API.UnitTests.Handlers
{
    ...
    public class S100DataContentPublishedEventHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _fakeS100DataContentPublishedEventHandler = new S100DataContentPublishedEventHandler(_fakeLogger, _fakeAzureTableReaderWriter, _fakeAzureBlobReaderWriter, _fakeXmlTransformer);
        }
