...
namespace UKHO.ERPFacade.API.UnitTests.Helpers
{
    ...
    public class SapMessageBuilderTests
    {
        ...
        private string sapXmlFile = @"<?xml version=""1.0"" encoding=""utf-8""?>
...
";
        ...
        [Test]
        public void WhenBuildSapMessageXmlIsCalled_ThenReturnXMLDocument()
        {
