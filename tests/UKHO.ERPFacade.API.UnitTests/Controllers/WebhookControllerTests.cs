    ...
    public class WebhookControllerTests
    {
        ...
        public async Task WhenValidEventInLicenceUpdatedPublishedEventReceived_ThenWebhookReturns200OkResponse()
        {
            ...
            A.CallTo(_fakeLogger).Where(call => call.Method.Name == "Log"
             ...
             && call.GetArgument<IEnumerable<KeyValuePair<string, object>>>(2)!.ToDictionary(c => c.Key, c => c.Value)["{OriginalFormat}"].ToString() == "ERP Facade webhook has received new licenceupdatedpublish event from EES.").MustHaveHappenedOnceExactly();
