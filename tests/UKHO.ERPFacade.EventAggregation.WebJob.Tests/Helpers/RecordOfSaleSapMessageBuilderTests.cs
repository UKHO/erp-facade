...
";
        ...
        private readonly string jsonForMigrateNewLicence2 = @"{""specversion"": ""1.0"",""type"": ""uk.gov.ukho.shop.recordOfSale.v1"",""source"": ""https://uk.gov.ukho.shop"",""id"": ""e744fa37-0c9f-4795-adc9-7f42ad8f1234"",""time"": ""2023-07-20T10:40:00.000000Z"",""subject"": ""releasability set changes holdings Record of Sale"",""datacontenttype"": ""application/json"",""data"": {""correlationId"": ""123-abc-456-xyz-333"",""relatedEvents"": [""e744fa37-0c9f-4795-adc9-7f42ad8f11c1""],""recordsOfSale"": 
            {""licenseId"": ""2"",""productType"": ""AVCS"",""transactionType"": ""MIGRATENEWLICENCE"",""distributorCustomerNumber"": ""111"",""shippingCoNumber"": ""1"",""ordernumber"": ""XXL005456375"",""orderDate"": ""2023-06-20"",""po-ref"": ""75277T-Bengang"",""holdingsExpiryDate"": ""2025-06-30"",""sapId"": """",""vesselName"": ""Cornelia Maersk"",""imoNumber"": ""IMO9245756"",""callSign"": ""OWWS2"",""licenceType"": ""02"",""shoreBased"": ""X"",""fleetName"": """",""numberLicenceUsers"": 1,""ecdisManufacturerId"": ""MARIS"",""licenceDuration"": 12,""unitsOfSale"": [{""unitName"": ""PT111102"",""endDate"": ""2023-10-31"",""duration"": ""3"",""renew"": ""N"",""repeat"": """"},{""unitName"": ""GB302408"",""endDate"": ""2023-12-01"",""duration"": ""6"",""renew"": ""N"",""repeat"": """"}]}}}";
        ...
        {
            var jsonData1 = JsonConvert.DeserializeObject<RecordOfSaleEventPayLoad>(jsonForMigrateNewLicence1);
            var jsonData2 = JsonConvert.DeserializeObject<RecordOfSaleEventPayLoad>(jsonForMigrateNewLicence2);
        ...
        [Test]
        public void WhenTransactionTypeIsMigrateNewLicence_ThenReturns_SomeFieldsEmptyInSapXmlPayloadCreationTests()
        {
            var jsonData1 = JsonConvert.DeserializeObject<RecordOfSaleEventPayLoad>(jsonForMigrateNewLicence1);
            var jsonData2 = JsonConvert.DeserializeObject<RecordOfSaleEventPayLoad>(jsonForMigrateNewLicence2);
