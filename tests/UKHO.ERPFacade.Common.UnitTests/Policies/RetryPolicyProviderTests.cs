...
namespace UKHO.ERPFacade.Common.UnitTests.Policies
{
    internal class RetryPolicyProviderTests
    {
        ...
        public async Task WhenValidInputsProvided_ThenCreateRetrypolicySuccessfully()
        {
            ...
            var policy = _fakeRetryPolicyProvider.CreateRetryPolicy("TestService", EventIds.RetryAttemptForEnterpriseEventServiceEvent, 3, 2);
