...
namespace UKHO.ERPFacade.StubService.Stubs
{
    public class SapServiceStub : IStub
    {
        ...
        public SapServiceStub(S57EncEventConfiguration encEventConfiguration, RecordOfSaleEventConfiguration recordOfSaleEventConfiguration, S100DataEventConfiguration s100DataEventConfiguration)
        {
