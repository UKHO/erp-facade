...
namespace UKHO.ERPFacade
{
    ...
    internal class Program
    {
        ...
        internal static void Main(string[] args)
        {
            ...
            }).AddPolicyHandler((services, request) => RetryPolicyProvider.GetRetryPolicy(services.GetService<ILogger<IEesClient>>(), "Enterprise Event Service", retryPolicyConfiguration.RetryCount, retryPolicyConfiguration.Duration));
