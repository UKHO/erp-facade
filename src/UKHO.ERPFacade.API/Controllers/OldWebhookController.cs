...
//    [ApiController]
//    [Authorize]
//    public class OldWebhookController : BaseController<OldWebhookController>
//    {
//        private readonly ILogger<OldWebhookController> _logger;
...
//        public OldWebhookController(IHttpContextAccessor contextAccessor,
//                                 ILogger<OldWebhookController> logger,
...
//            EventEntity encEventEntity = new()
//            {
...
//            var sapPayload = _encContentSapMessageBuilder.BuildXmlPayload(JsonConvert.DeserializeObject<S57EventData>(encEventJson.ToString()), Constants.S57SapXmlTemplatePath);
