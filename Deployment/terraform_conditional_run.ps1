...
Write-Host "##vso[task.setvariable variable=ResourceGroup]$($terraformOutput.resource_group.value)"
...
Write-Host "##vso[task.setvariable variable=APPINSIGHTS_INSTRUMENTATIONKEY;issecret=true;isOutput=true]$($terraformOutput.storage_connection_string.value)"
