locals {
  ...
  addsmock_web_app_name  = "${local.service_name}-${local.env_name}-addsmockservice"
  ...
  addsmock_private_connection = "/subscriptions/${var.subscription_id}/resourceGroups/erpfacade-${local.env_name}-rg/providers/Microsoft.Web/sites/erpfacade-${local.env_name}-addsmockservice" 
