            ...
            hostBuilder.ConfigureAppConfiguration((hostContext, builder) =>
            {
             ...
             .ConfigureLogging((hostContext, builder) =>
             {
                 ...
                 builder.AddSerilog(new LoggerConfiguration()
                                 .WriteTo.File("Logs/UKHO.ERPFacade.EventAggregation.WebJob-.txt", rollingInterval: RollingInterval.Day, outputTemplate: "{Timestamp:yyyy-MM-dd HH:mm:ss} [{Level}] [{SourceContext}] {Message}{NewLine}{Exception}")
